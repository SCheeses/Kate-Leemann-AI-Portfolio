...
2. Open [`L04_Chihuahua_or_Muffin.ipynb`](L04_Chihuahua_or_Muffin.ipynb).
...
- [`L04_Chihuahua_or_Muffin.ipynb`](L04_Chihuahua_or_Muffin.ipynb) - executed source notebook
- [`results/`](results/) - dataset preview and saved validation predictions
- [`report/L04_Chihuahua_or_Muffin_Report.pdf`](report/L04_Chihuahua_or_Muffin_Report.pdf) - full project report

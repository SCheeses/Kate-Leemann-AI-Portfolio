...
1. Open [`Image_Processing_Fundamentals.ipynb`](Image_Processing_Fundamentals.ipynb) in Google Colab.
...
- [`Image_Processing_Fundamentals.ipynb`](Image_Processing_Fundamentals.ipynb) - executed source notebook
- [`results/`](results/) - selected standalone notebook outputs
- [`report/Image_Processing_Reflection.pdf`](report/Image_Processing_Reflection.pdf) - written reflection

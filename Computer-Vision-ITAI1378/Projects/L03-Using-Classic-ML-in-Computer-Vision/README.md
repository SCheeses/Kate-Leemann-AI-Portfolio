...
1. Open [`L03_Using_Classic_ML_in_Computer_Vision.ipynb`](L03_Using_Classic_ML_in_Computer_Vision.ipynb) in Colab.
...
jupyter notebook L03_Using_Classic_ML_in_Computer_Vision.ipynb
```
...
- [`L03_Using_Classic_ML_in_Computer_Vision.ipynb`](L03_Using_Classic_ML_in_Computer_Vision.ipynb) - executed source notebook
- [`results/`](results/) - preprocessing, confusion-matrix, and prediction images
- [`report/L03_Using_Classic_ML_in_Computer_Vision_Report.pdf`](report/L03_Using_Classic_ML_in_Computer_Vision_Report.pdf) - full project report
